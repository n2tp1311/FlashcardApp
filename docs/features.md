...
- Session summary screen: finishing a flashcard session (not an early Exit) shows total cards graded, a New vs. Review split, and a per-status breakdown (Learning/Hard/Know It/Confident, colored to match the grading buttons) before returning to the lesson; notes how many cards were skipped (navigated past without grading) if any were. Quiz mode already has its own Results screen (score/percentage/grade) and wasn't touched
